...
sealed class FilterOriginalCriticalMultiplier(id: String) : Filter<NoCompileData, Double>(id) {
    ...
    final override fun isMet(data: TriggerData, value: Double, compileData: NoCompileData): Boolean {
        ...
        return compare(event.originalCriticalMultiplier.toDouble(), value)
    }
    ...
    object Equals : FilterOriginalCriticalMultiplier("original_critical_multiplier_equals") {
        override fun compare(criticalMultiplier: Double, value: Double): Boolean {
            return criticalMultiplier == value
        }
    }

    object AtLeast : FilterOriginalCriticalMultiplier("original_critical_multiplier_at_least") {
        override fun compare(criticalMultiplier: Double, value: Double): Boolean {
            return criticalMultiplier >= value
        }
    }

    object AtMost : FilterOriginalCriticalMultiplier("original_critical_multiplier_at_most") {
        override fun compare(criticalMultiplier: Double, value: Double): Boolean {
            return criticalMultiplier <= value
        }
    }

    object GreaterThan : FilterOriginalCriticalMultiplier("original_critical_multiplier_greater_than") {
        override fun compare(criticalMultiplier: Double, value: Double): Boolean {
            return criticalMultiplier > value
        }
    }

    object LowerThan : FilterOriginalCriticalMultiplier("original_critical_multiplier_lower_than") {
        override fun compare(criticalMultiplier: Double, value: Double): Boolean {
            return criticalMultiplier < value
        }
    }
