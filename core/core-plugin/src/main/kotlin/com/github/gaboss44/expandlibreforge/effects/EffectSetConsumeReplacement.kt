...
object EffectSetConsumeReplacement : Effect<ItemStack>("set_consume_replacement") {
    override val parameters = setOf(
        TriggerParameter.EVENT
    )

    override val arguments = arguments {
        require("item", "You must specify the item for consumption replacement")
    }
