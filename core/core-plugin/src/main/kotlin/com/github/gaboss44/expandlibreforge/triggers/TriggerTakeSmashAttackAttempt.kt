...
sealed class TriggerTakeSmashAttackAttempt(id: String) : Trigger(id) {
    ...
    object Default : TriggerTakeSmashAttackAttempt("take_smash_attack_attempt") {
        @EventHandler(ignoreCancelled = true)
        fun onSmashAttempt(event: EntityEvent) = handle(event)
    }

    object HighestPriority : TriggerTakeSmashAttackAttempt("take_smash_attack_attempt_highest_priority") {
        @EventHandler(priority = EventPriority.HIGHEST, ignoreCancelled = true)
        fun onSmashAttempt(event: EntityEvent) = handle(event)
    }

    object HighPriority : TriggerTakeSmashAttackAttempt("take_smash_attack_attempt_high_priority") {
        @EventHandler(priority = EventPriority.HIGH, ignoreCancelled = true)
        fun onSmashAttempt(event: EntityEvent) = handle(event)
    }

    object NormalPriority : TriggerTakeSmashAttackAttempt("take_smash_attack_attempt_normal_priority") {
        @EventHandler(priority = EventPriority.NORMAL, ignoreCancelled = true)
        fun onSmashAttempt(event: EntityEvent) = handle(event)
    }

    object LowPriority : TriggerTakeSmashAttackAttempt("take_smash_attack_attempt_low_priority") {
        @EventHandler(priority = EventPriority.LOW, ignoreCancelled = true)
        fun onSmashAttempt(event: EntityEvent) = handle(event)
    }

    object LowestPriority : TriggerTakeSmashAttackAttempt("take_smash_attack_attempt_lowest_priority") {
        @EventHandler(priority = EventPriority.LOWEST, ignoreCancelled = true)
        fun onSmashAttempt(event: EntityEvent) = handle(event)
    }

    object Monitor : TriggerTakeSmashAttackAttempt("take_smash_attack_attempt_monitor") {
